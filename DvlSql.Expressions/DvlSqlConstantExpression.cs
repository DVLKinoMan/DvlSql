...
using static DvlSql.Models.SqlType;
...
namespace DvlSql.Models
{
    public abstract class DvlSqlConstantExpression : DvlSqlExpression
    {
        ...
        public static implicit operator DvlSqlConstantExpression(string str) 
            => new DvlSqlConstantExpression<string>(str, true);
        
        public static implicit operator DvlSqlConstantExpression(int num) 
            => new DvlSqlConstantExpression<int>(num);
        
        public static implicit operator DvlSqlConstantExpression(double num) 
            => new DvlSqlConstantExpression<double>(num);
        
        public static implicit operator DvlSqlConstantExpression(DateTime dateTime) 
    ...
    public class DvlSqlConstantExpression<TValue> : DvlSqlConstantExpression
    {
        ...
        public override DvlSqlConstantExpression ConstantClone() 
        ...
        public string StringValue => !IsTableColumn && this.Value is string ? $"'{this.Value}'" 
            : GetDefaultSqlString(this.Value);
